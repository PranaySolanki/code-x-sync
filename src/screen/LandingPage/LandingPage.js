...
import insightsImg from './assets/images/home/insights.png';
...
const LandingPage = () => {
    useEffect(() => {
        ...
        return () => {
            if (collapseBtn) collapseBtn.removeEventListener('click', toggleHeader);
            window.removeEventListener("click", onHeaderClickOutside);
            faqAccordions.forEach(btn => btn.removeEventListener('click', handleAccordionClick));
    ...
    return (
        <div className='landing-page-container'>
            <div className="tw-flex tw-min-h-[100vh] tw-flex-col tw-bg-black tw-text-white">
                <header className="LPheader tw-max-w-lg:tw-px-4 tw-max-w-lg:tw-mr-auto tw-absolute tw-top-0 tw-z-20 tw-flex tw-h-[60px] tw-w-full tw-bg-opacity-0 tw-px-[5%] lg:tw-justify-around" id='about'>
                    <a className="a tw-h-[50px] tw-w-[50px] tw-p-[4px] tw-flex tw-items-center">
                        <img src={logo} alt="logo" className="tw-object tw-h-full tw-w-full" />
                        <span className="tw-ml-4">CodeXSync</span>
                    </a>
                    <div className="collapsible-header animated-collapse max-lg:tw-shadow-md" id="collapsed-header-items">
                        <div className="tw-flex tw-h-full tw-w-max tw-gap-5 tw-text-base max-lg:tw-mt-[30px] max-lg:tw-flex-col max-lg:tw-place-items-end max-lg:tw-gap-5 lg:tw-mx-auto lg:tw-place-items-center">
                            <a className="a LPheader-links" href="">About us</a>
                            <a className="a LPheader-links" href="#features">Features</a>
                            <a className="a LPheader-links" href="#working">How it works</a>
                            <a className="a LPheader-links" href="#faq">FAQ</a>
                            <a className="a LPheader-links" href="#/">Dashboard</a>
                        </div>
                        <div className="tw-mx-4 tw-flex tw-place-items-center tw-gap-[20px] tw-text-base max-md:tw-w-full max-md:tw-flex-col max-md:tw-place-content-center">
                            <a href="/login" aria-label="signup" className="a tw-rounded-full tw-bg-white tw-px-3 tw-py-2 tw-text-black tw-transition-transform tw-duration-[0.3s] hover:tw-translate-x-2">
                    ...
                    <button
                        className="LPbutton bi bi-list tw-absolute tw-right-3 tw-top-3 tw-z-50 tw-text-3xl tw-text-white lg:tw-hidden"
                        aria-label="menu"
                        id="collapse-btn"
                    ></button>
                </header>
                        ...
                        <div className="tw-flex tw-h-full tw-min-h-[100vh] tw-w-full tw-flex-col tw-place-content-center tw-gap-6 tw-p-[5%] max-xl:tw-place-items-center max-lg:tw-p-4">
                            <div className="tw-flex tw-flex-col tw-place-content-center tw-items-center">
                                <div className="reveal-up gradient-text tw-text-center tw-text-6xl tw-font-semibold tw-uppercase tw-leading-[80px] max-lg:tw-text-4xl max-md:tw-leading-snug">
                                    <span>Code Together, Faster Than Ever.</span>
                                </div>
                                ...
                                <div className="reveal-up tw-mt-10 tw-flex tw-place-items-center tw-gap-4">
                                    <a className="a LPbtn tw-bg-[#7e22ce85] tw-shadow-lg tw-shadow-primary tw-transition-transform tw-duration-[0.3s] hover:tw-scale-x-[1.03]" href="/login">Get started</a>
                            ...
                            <div className="reveal-up tw-relative tw-mt-8 tw-flex tw-w-full tw-place-content-center tw-place-items-center" id="dashboard-container">
                                <div className="tw-relative tw-max-w-[80%] tw-overflow-hidden tw-rounded-xl tw-bg-transparent max-md:tw-max-w-full" id="dashboard">
                                    <img src={dashboardImg} alt="dashboard" className="tw-h-full tw-w-full tw-object-cover tw-opacity-90 max-lg:tw-object-contain" />
                                </div>
                    ...
                    {/* <section className="tw-relative tw-flex tw-w-full tw-max-w-[100vw] tw-flex-col tw-place-content-center tw-place-items-center tw-overflow-hidden tw-p-8">
                        ...
                        <div className="reveal-up carousel-container">
                            <div className="carousel lg:w-place-content-center tw-mt-6 tw-flex tw-w-full tw-gap-5 max-md:tw-gap-2">
                                <div className="carousel-img tw-h-[30px] tw-w-[150px]"><img src={googleLogo} alt="Google" className="tw-h-full tw-w-full tw-object-contain tw-grayscale tw-transition-colors hover:tw-grayscale-0" /></div>
                                <div className="carousel-img tw-h-[30px] tw-w-[150px]"><img src={microsoftLogo} alt="Microsoft" className="tw-h-full tw-w-full tw-object-contain tw-grayscale tw-transition-colors hover:tw-grayscale-0" /></div>
                                <div className="carousel-img tw-h-[30px] tw-w-[150px]"><img src={adobeLogo} alt="Adobe" className="tw-h-full tw-w-full tw-object-contain tw-grayscale tw-transition-colors hover:tw-grayscale-0" /></div>
                                <div className="carousel-img tw-h-[30px] tw-w-[150px]"><img src={airbnbLogo} alt="Airbnb" className="tw-h-full tw-w-full tw-object-contain tw-grayscale tw-transition-colors hover:tw-grayscale-0" /></div>
                                <div className="carousel-img tw-h-[30px] tw-w-[150px]"><img src={stripeLogo} alt="Stripe" className="tw-h-full tw-w-full tw-object-contain tw-grayscale tw-transition-colors hover:tw-grayscale-0" /></div>
                            </div>
                        </div>
                    </section> */}
                    ...
                    <section className="tw-relative tw-flex tw-min-h-[80vh] tw-w-full tw-max-w-[100vw] tw-flex-col tw-place-content-center tw-place-items-center tw-overflow-hidden tw-p-6">
                        <div className="tw-mt-8 tw-flex tw-flex-col tw-place-items-center tw-gap-5">
                            ...
                            <div className="tw-mt-6 tw-flex tw-max-w-[80%] tw-flex-wrap tw-place-content-center tw-gap-8 max-lg:tw-flex-col">
                                ...
                                <div className="reveal-up tw-flex tw-h-[200px] tw-w-[450px] tw-gap-8 tw-rounded-xl tw-border-[1px] tw-border-outlineColor tw-bg-secondary tw-p-8 max-md:tw-w-[320px]">
                                    <div className="tw-text-4xl max-md:tw-text-2xl"><i className="bi bi-bi-folder2-open"></i></div>
                                    <div className="tw-flex tw-flex-col tw-gap-4">
                        ...
                        <div className="reveal-up tw-flex tw-min-h-[60vh] tw-place-content-center tw-place-items-center tw-gap-[10%] max-lg:tw-flex-col max-lg:tw-gap-10">
                            <div className="tw-flex">
                                <div className="tw-max-h-[650px] tw-max-w-[850px] tw-overflow-hidden tw-rounded-lg tw-shadow-lg tw-shadow-[rgba(170,49,233,0.44021358543417366)]">
                                    <img src={insightsImg} alt="coding" className="tw-h-full tw-w-full tw-object-cover" />
                                </div>
                            </div>
                        ...
                        <div className="tw-mt-8 tw-gap-10 tw-space-y-8 max-md:tw-columns-1 lg:tw-columns-2 xl:tw-columns-2">
                            <div className="reveal-up tw-flex tw-h-fit tw-w-[350px] tw-break-inside-avoid tw-flex-col tw-gap-4 tw-rounded-lg tw-border-[1px] tw-border-outlineColor tw-bg-secondary tw-p-4 max-lg:tw-w-[320px]">
                                ...
                                <div className="tw-flex tw-place-items-center tw-gap-3">
                                    <div className="tw-h-[50px] tw-w-[50px] tw-overflow-hidden tw-rounded-full"><img src={manImg} className="tw-h-full tw-w-full tw-object-cover" alt="man" /></div>
                ...
                <footer className="tw-mt-auto tw-flex tw-w-full tw-place-content-around tw-gap-3 tw-p-[5%] tw-px-[10%] tw-text-white max-md:tw-flex-col">
                    <div className="tw-flex tw-h-full tw-w-[250px] tw-flex-col tw-place-items-center tw-gap-6 max-md:tw-w-full">
                        <img src={logo} alt="logo" className="tw-max-w-[120px]" />
